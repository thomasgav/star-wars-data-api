# Generated by Django 5.1.5 on 2025-08-19 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.ManyToManyField(blank=True, related_name='films', to='core.species')),
                ('starships', models.ManyToManyField(blank=True, related_name='films', to='core.starship')),
                ('vehicles', models.ManyToManyField(blank=True, related_name='films', to='core.vehicle')),
            ],
            options={
                'ordering': ['-created_at', '-updated_at'],
                'abstract': False,
